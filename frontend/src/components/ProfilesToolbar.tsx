import { StatusDot, IconButton, type UiStatus } from '../ui';
...
const SORTS: { k: SortKey; label: string }[] = [
  { k: 'status', label: 'Sort: Status' },
  { k: 'name', label: 'Sort: Name' },
  { k: 'group', label: 'Sort: Group' },
  { k: 'lastUsed', label: 'Sort: Last used' },
];
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 20px', borderBottom: '1px solid var(--border)', flexWrap: 'wrap' }}>
      ...
      <select
        ...
        style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', color: 'var(--text-2)', borderRadius: 'var(--r-sm)', padding: '6px 8px', fontSize: 12.5, cursor: 'pointer' }}
      >
